...
$(".stop-talk").fadeOut(0.000000000000000001);
...
if ("webkitSpeechRecognition" in window) {
  document.querySelector(".start-talk").addEventListener("click", () => {
    ...
    $(".start-talk").fadeOut(0.000000000000000001);
    $(".stop-talk").fadeIn(0.000000000000000001);
  });


  document.querySelector(".stop-talk").addEventListener("click", () => {
    speechRecognition.stop();
    $(".stop-talk").fadeOut(0.000000000000000001);
    $(".start-talk").fadeIn(0.000000000000000001);
  });
